        ...
        <div className="flex items-center gap-3">
          {userState.email ? (
            <>
              ...
              <Link 
                href="/billing"
                className={`px-2 py-0.5 rounded font-mono text-[10px] font-bold tracking-wider transition ${
                  userState.tier === 'Pro'
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-1 rounded hover:bg-[#181a25] text-[#8b949e] hover:text-red-400 transition ml-1 cursor-pointer"
                  title="Logout"
                  id="btn-logout"
                >
