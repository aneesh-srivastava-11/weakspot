...
import { CreditCard, Sparkles, Check, HelpCircle, Key, ChevronRight, Layers, Cpu } from 'lucide-react';
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-[#11131c] border border-[#1e2230] mb-6">
              ...
              <div className="text-right">
                ...
                <span className="font-mono text-[9px] text-[#5b647f]">
                  {isFree ? 'Permanent' : 'Renews Jul 24, 2026'}
                </span>
              </div>
            </div>
              ...
              <div className="space-y-4" id="usage-meter-container">
                ...
                <div className="flex justify-between items-start pt-1">
                  ...
                  <button
                    ...
                    className="font-sans text-xs font-semibold text-blue-400 hover:text-blue-300 flex items-center gap-1 transition ml-4"
                ...
                {onDowngradeToFree && (
                  <div className="pt-2 flex justify-start">
                    <button
                      ...
                      className="font-sans text-[10px] text-[#5b647f] hover:text-red-400 hover:underline transition"
                      id="btn-downgrade-simulate"
                    >
                      Downgrade to Free tier (Simulate Free experience)
                    </button>
                  </div>
                )}
              </div>
